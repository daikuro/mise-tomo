...
<div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div class="max-w-md w-full space-y-8">
    ...
    <form class="mt-8 space-y-6" onsubmit={(e) => { e.preventDefault(); handleEmailLogin(); }}>
      {#if error}
        ...
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              required
              bind:value={email}
              class="appearance-none relative block w-full px-10 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
              placeholder="メールアドレス"
            />
          </div>
        </div>
        <div>
          ...
          <div class="relative">
            ...
            <input
              ...
              required
              bind:value={password}
              class="appearance-none relative block w-full px-10 py-3 border-t-0 border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm"
              placeholder="パスワード"
            />
          </div>
        </div>
